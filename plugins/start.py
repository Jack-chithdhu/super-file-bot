...
async def start_command(client: Client, message: Message):
    ...
    if captcha_enabled and user_id not in ADMINS:
        from plugins.captcha import send_captcha
    ...
    # Show Settings button only for owner/admins
    if user_id in ADMINS:
        buttons.insert(-1, [InlineKeyboardButton("⚙️ Settings", callback_data="open_settings")])
