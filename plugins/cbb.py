...
# ═════════════════════════════════════════════════════════════════════════════
@Bot.on_callback_query(filters.regex(r"^(about|premium_info|buy_premium|back_home|close|help_menu|user_profile|my_requests|close_my_chat|open_settings)$"))
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    # ── Buy Premium ───────────────────────────────────────────────────────
        ...
        text = (
            ...
            f"  🏦 Bank: {bank}\n\n"
            f"📝 <b>Note:</b> {note}\n\n"
            f"After payment, tap <b>Contact Admin</b> and send your screenshot."
        )
